...
function SidebarMenuSkeleton({
  ...
  // Random width between 50 to 90%, picked once per skeleton instance so it
  // stays stable across re-renders. `useState` with an init function is the
  // React-blessed way to defer impure work to mount.
